<script lang="ts">
    ...
    const formattedDate = new Intl.DateTimeFormat('en-GB', { weekday: "short", day: 'numeric', month: 'short', year : 'numeric'}).format(date)
    const formattedHijriDate = new Intl.DateTimeFormat('ar-TN-u-ca-islamic', {day: 'numeric', month: 'long',year : 'numeric'}).format(date);
</script>
